...
folder_path = "C:\\Users\\146767\\OneDrive - Arrow Electronics, Inc\\Desktop\\All python files\\Quote Factory"
...
for file in os.listdir(folder_path):
    if file.endswith(".xlsx") or file.endswith(".xls"): # Solo filtre archivos de Excel
        ...
        df = pd.read_excel(file_path, engine='openpyxl') # Leer archivo de excel
...
if dataFrames:
    ...
    print(df_final.head()) # Mostrar las primeras filas
# Guardar el DataFrame final en un archivo CSV para poder pasarlo a Power BI
    df_final.to_csv('datos_combinados_ods.csv', index=False) # Aqui se guarda el archivo CSV
    print("Datos exportados a 'datos_combinados_ods.csv'.")    
else:
    print("No se encontraron archivos Excel en la carpeta ODS.")
